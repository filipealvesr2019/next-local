...
const PasswordResetRequestUser = () => {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      toast.success(
        "Email de recuperação enviado com sucesso cheque a sua caixa de email!"
      );
    } catch (error) {
    ...
    <>
      ...
      <div className={styles.formContainer}>
        ...
        <form onSubmit={handleSubmit} className={styles.formContainer__form}>
          ...
          <div>
            {" "}
            <button type="submit" className={styles.formContainer__button}>
              Enviar
            </button>
          </div>
        </form>
...
export default PasswordResetRequestUser;
